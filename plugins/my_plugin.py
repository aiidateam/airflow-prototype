# $AIRFLOW_HOME/plugins/my_plugin.py
...
try:
    from custom_xcom_backend import get_xcom_stats, get_recent_xcom_operations, get_xcom_values_from_airflow
except ImportError:
    try:
        from plugins.custom_xcom_backend import get_xcom_stats, get_recent_xcom_operations, get_xcom_values_from_airflow
    except ImportError:
        def get_xcom_stats():
