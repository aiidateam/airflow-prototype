...
from airflow_provider_aiida.aiida_core.engine.processes.process import Process
from airflow_provider_aiida.aiida_core.engine.processes.ports import PortNamespace
...
class CalcJob(Process):
    ...
    # TODO  
    #def presubmit(self, folder: Folder, node: CalcJobNode) -> CalcInfo:
