...
def from_profile_create_airflow_config(profile: Profile):
    ...
    dag_bundle = '[{"name":"dags-folder","classpath":"airflow.dag_processing.bundles.local.LocalDagBundle","kwargs":{}},{"name":"aiida_dags","classpath":"airflow_provider_aiida.bundles.aiida_dag_bundle.AiidaDagBundle","kwargs":{}}]'
    ...
    if not airflow_config_file.exists():
